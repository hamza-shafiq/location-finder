...
attachments = {
    "banner": "banner.png",
    "bitcoin_logo": "bitcoin.png",
    "payment_method": "bitcoinpaymentmethod.png",
    "left1": "bitcoinacceptedcompony.png",
    "left2": "bitcoinacceptedcompony.png",
    "left3": "bitcoinacceptedcompony.png",
    "left4": "bitcoinacceptedcompony.png",
    "right1": "bitcoinacceptedcompony.png",
    "right2": "bitcoinacceptedcompony.png",
    "right3": "bitcoinacceptedcompony.png",
    "right4": "bitcoinacceptedcompony.png",
}
...
class MyApp(QWidget):
    ...
    def get_info(self):
        ...
        if not ip_address:
            return "Please check your internet connection & try again!"
    ...
    def init_ui(self):
        ...
        banner_image_path = os.path.join(base_path, "assets", attachments["banner"])
        banner_label = QLabel()
        ...
        image_paths = [
            os.path.join(base_path, "assets", attachments["left1"]),
            os.path.join(base_path, "assets", attachments["left2"]),
            os.path.join(base_path, "assets", attachments["left3"]),
            os.path.join(base_path, "assets", attachments["left4"]),
        ]
        ...
        image_path = os.path.join(base_path, "assets", attachments["bitcoin_logo"])
        ...
        bitcoin_payment = os.path.join(base_path, "assets", attachments["payment_method"])
        ...
        image_paths = [
            os.path.join(base_path, "assets", attachments["right1"]),
            os.path.join(base_path, "assets", attachments["right2"]),
            os.path.join(base_path, "assets", attachments["right3"]),
            os.path.join(base_path, "assets", attachments["right4"]),
        ]
